export type { Clock } from "@isittaken/core";

/**
 * Web-only provider and repository ports. Transport-neutral ports (Clock,
 * RawCandidate, CandidateSource, PackageRegistry, RegistryValidation) live in
 * `@isittaken/core`; this module holds the interfaces that are specific to
 * the web application (caching, auth, quota, creative generation).
 */
